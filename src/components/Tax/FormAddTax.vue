<template>
  <div class="container-fluid">
    ...
    <div class="mt-4">
      ...
      <input v-on:keyup.enter="submitAddTax" v-model="year" type="number" class="form-control" />
    </div>
    <div class="mt-4">
      <label class="form-label">Jumlah</label>
      <input aria-describedby="basic-addon1" v-on:keyup.enter="submitAddTax" v-model="amount" type="number" class="form-control" />
    </div>
    <div class="mt-4">
