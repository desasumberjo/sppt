...
export default {
  ...
  methods: {
    submit(){
      ...
      axios.patch('https://spptdesasumberjo.herokuapp.com/api/v1/sppt/guardian-update',
        {
        ...
        .then(() => {
          axios.delete('https://spptdesasumberjo.herokuapp.com/api/v1/guardian/' + sessionStorage.getItem("IDGuardian"),
            {
              headers: {
                Authorization: `Bearer ${sessionStorage.getItem("token")}`,
              },
  ...
  mounted: function(){
    axios.get('https://spptdesasumberjo.herokuapp.com/api/v1/sppt/guardian/' + sessionStorage.getItem("IDGuardian"),
      {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
        },
